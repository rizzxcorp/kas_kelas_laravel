...
<div class="w-64 bg-gray-200 h-screen p-4 flex flex-col justify-between sticky top-0">
    <div>
        ...
        <nav class="space-y-2">
            ...
            <a class="flex items-center p-2 text-gray-900 bg-blue-100 rounded-md" href="pengeluaran.php">
     ...
     <table class="w-full text-left border-collapse">
      ...
      <tbody>
       <tr>
        ...
        <td class="border-b p-2">Spidol</td>
        <td class="border-b p-2">01-02-25</td>
        <td class="border-b p-2">10,000</td>
        <td class="border-b p-2">
         <button class="bg-yellow-400 text-white px-2 py-1 rounded-md mr-2">Edit</button>
