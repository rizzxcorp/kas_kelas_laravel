...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    <div class="flex">
        ...
        <div class="w-64 bg-gray-200 h-screen fixed p-4 flex flex-col justify-between">
            <div>
                ...
                <nav class="space-y-2">
                    ...
                    <a class="flex items-center p-2 text-gray-900 bg-white rounded-md" href="pemaasukan.php">
        ...
        <div class="flex-1 p-6 ml-64">
            ...
            <div class="mb-4">
                <button class="bg-blue-500 text-white px-4 py-2 rounded-md">TAMBAH TRANSAKSI</button>
            </div>
            ...
            <table class="min-w-full bg-white border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border">Ikbal Fadillah</td>
                        <td class="py-2 px-4 border">Januari</td>
                        <td class="py-2 px-4 border">2025</td>
                        <td class="py-2 px-4 border">25.000</td>
                        <td class="py-2 px-4 border"><span class="bg-green-500 text-white px-2 py-1 rounded-md">LUNAS</span></td>
                        <td class="py-2 px-4 border">
                            <button class="bg-yellow-500 text-white px-2 py-1 rounded-md mr-2">Edit</button>
                            <button class="bg-red-500 text-white px-2 py-1 rounded-md">Hapus</button>
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border">Rizky Syahputra</td>
                        <td class="py-2 px-4 border">Januari</td>
                        <td class="py-2 px-4 border">2025</td>
                        <td class="py-2 px-4 border">15.000</td>
                        <td class="py-2 px-4 border"><span class="bg-green-500 text-white px-2 py-1 rounded-md">LUNAS</span></td>
                        <td class="py-2 px-4 border">
                            <button class="bg-yellow-500 text-white px-2 py-1 rounded-md mr-2">Edit</button>
                            <button class="bg-red-500 text-white px-2 py-1 rounded-md">Hapus</button>
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border">Rechard Bakarbessy</td>
                        <td class="py-2 px-4 border">Januari</td>
                        <td class="py-2 px-4 border">2025</td>
                        <td class="py-2 px-4 border">15.000</td>
                        <td class="py-2 px-4 border"><span class="bg-green-500 text-white px-2 py-1 rounded-md">LUNAS</span></td>
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border">Muhammad Hanif</td>
                        <td class="py-2 px-4 border">Januari</td>
                        <td class="py-2 px-4 border">2025</td>
                        <td class="py-2 px-4 border">10.000</td>
                        <td class="py-2 px-4 border"><span class="bg-green-500 text-white px-2 py-1 rounded-md">LUNAS</span></td>
